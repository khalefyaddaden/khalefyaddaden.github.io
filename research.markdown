...
multiple polylogarithme values at roots of unity. My field of reseach is an intersection between algebraic topology, algebraic geometry and categories. More precisely, my current work is about studying and understanding Racinet's harmonic coproduct by describing the so called double shuffle relations as algebraic operations on a non commutative formal series algebra. My work is inspired by [this paper](https://arxiv.org/abs/1803.10151) from Enriquez and Furusho.
